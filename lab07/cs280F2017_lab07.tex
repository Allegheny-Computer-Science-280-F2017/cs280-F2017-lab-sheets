...
challenging and the strategies that you developed for addressing both technical and managerial challenges. Please think
carefully about the Python language features and packages that you found to be the most useful in completing the prior
assignments. Next, consider the best ways in which your class can use Travis, GitHub, and other external tools to
