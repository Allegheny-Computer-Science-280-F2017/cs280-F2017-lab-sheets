...
Slack to support communication with the course instructor. Next, you will learn how to understand a Python program's
source code, revise a Markdown document, run a test suite, and find and fix a defect in a software application.
