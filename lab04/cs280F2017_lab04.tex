...
that can be deployed into use immediate use. For this laboratory assignment, your team will work with the other teams in
the class tasked to collaboratively implement all of the features requested by the customer.
