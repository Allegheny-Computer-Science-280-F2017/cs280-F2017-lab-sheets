...
\begin{enumerate}
  ...
  \item All team members contribute correct, correct source code and documentation that supports the creation of a
    working and useful programming systems product.

  \item All team members attend the classroom discussion and share status updates and ideas.

  \item All team members regularly communicate in a respectful and informative manner.
...
the team members make meaningful contributions to the project, according to these standards. The course instructor will
assess team effectiveness as {\bf below average} when, as a whole, the team does not function according to the above
standards.
...
correctly fulfilled. The course instructor will assess product quality as {\bf below average} when, as a whole, the
product does not function according to the aforementioned standards.
