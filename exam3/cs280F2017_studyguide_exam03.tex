...
\begin{itemize}
  ...
  \item Knowledge of the relationships between the time needed to develop and
    maintain a software product. Also, the ``laws'' of software evolution and
    their aid in understanding this process.
  ...
  \item The ``No Silver Bullet'' hypothesis and how it connects to the course's
    goals. An understanding of the best way(s) to achieve an order-of-magnitude
