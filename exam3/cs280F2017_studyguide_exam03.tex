...
concepts that we discussed in the course modules. You can use the color scheme
...
sheet, then they should schedule a meeting with the instructor.
...
\begin{itemize}
  ...
  \item The steps taken during and the goals of acceptance, performance, and
  ...
  \item Strategies for measuring and predicting the reliability, availability,
    and maintainability of a software system; intuitively understand the
    equations used to calculate these values.

  \item The importance of test planning and documentation. Additionally, a
    holistic understanding of the tools and processes supporting trade-offs in
    test suite efficiency and effectiveness.

  \item The different approaches to documenting software in advance of system
    delivery; how good documentation supports effective use of open-source
    software released on GitHub.

  \item Specialized forms of documentation and the ways in which they aid users
    (e.g., troubleshooting guides, failure message references, lists of missing
    features, and feature roadmaps).

  \item Knowledge of the relationships between the time needed to develop and
    maintain a software product. The ``laws'' of software evolution and their
    aid in understanding this process.

  \item The different tasks performed during software maintenance and a
    knowledge of their challenges and benefits (e.g., adaptive and preventative
    maintenance of a software system).

  \item The role that technical debt plans in impeding the effective evolution
    of a programming systems product; be able to furnish and fully explain
    examples of technical debt.

  \item The role that refactoring plays in the rejuvenation of software. A basic
    understanding of the tasks that a software engineer performs during
  ...
  \item The ``No Silver Bullet'' hypothesis and how it connects to the course's
    goals. An understanding of the best ways in which to achieve an
    order-of-magnitude improvement in software quality.
...
ensure that you fully understand the material before taking the examination.

% When studying for the test, don't forget that the course Web site contains
% mobile-ready slides that provide you with an overview of the key concepts that
% we discussed. You can use the color scheme in the slides to notice points where
% we, for instance, completed an in-class activity, discussed a key point, or made
% reference to additional details available in the SETP and MMM textbooks.

% Finally, students are strongly encouraged to schedule a meeting during the
% course instructor's office hours so that we can resolve any of your questions
% about the material and ensure that you have the knowledge and skills necessary
% for doing well on this examination.
